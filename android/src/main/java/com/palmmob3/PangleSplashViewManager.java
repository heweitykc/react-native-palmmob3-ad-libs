...
import com.palmmob3.pangle.view.SplashView;

import java.util.Map;

public class PangleSplashViewManager extends ViewGroupManager<SplashView> {

    public static final String TAG = "PangleSplashView";
    private ReactContext mContext;

    public PangleSplashViewManager(ReactApplicationContext context) {
        mContext = context;
    }
